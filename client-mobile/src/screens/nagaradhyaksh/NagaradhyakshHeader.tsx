...
import { BarChart3, Bell } from 'lucide-react-native';
...
export function NagaradhyakshHeader({ onBellPress }: { onBellPress: () => void }) {
    ...
    <View style={styles.header}>
      <View style={styles.row}>
        <View style={styles.iconWrap}>
          <BarChart3 size={17} color={colors.white} />
        </View>
        <View style={{ flex: 1 }}>
          <Text style={styles.kicker}>Nagaradhyaksh</Text>
...
const styles = StyleSheet.create({
  header: { paddingTop: 52, backgroundColor: colors.red },
  ...
  badgeText: { color: colors.red, fontSize: 10, fontFamily: fonts.sansExtraBold },
